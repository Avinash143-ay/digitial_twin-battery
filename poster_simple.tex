...
\begin{bluebox}[title=🧠 Model 1: MoE-Enhanced Transformer]
\large
\textbf{Architecture:}
...
\begin{itemize}
    ...
    \item \textbf{2-Layer Transformer} (64 dim, 2 heads)
    \item \textbf{Dual-Branch Output}: μ/σ for voltage \& temperature
    \item \textbf{Parameters}: ~500K
    \item \textbf{Prediction Horizon}: 150 steps (300s)
\end{itemize}

\vspace{0.5cm}
\textbf{Performance:}
\begin{itemize}
    \item \textbf{Voltage MAPE}: 0.158\% \textbf{⭐}
    \item \textbf{Temperature MAPE}: 0.698\%
    \item \textbf{Validation Loss}: 0.00219
    \item \textbf{Inference Time}: <50ms
...
\begin{itemize}
    ...
    \item \textbf{Ensemble:} 10 independent networks
    \item \textbf{Parameters:} 200K × 10 = 2M total
    \item \textbf{Activation:} GELU
    \item \textbf{Prediction Horizon:} 75 steps (150s)
\end{itemize}

\textbf{Performance:}
\begin{itemize}
    \item \textbf{Voltage MAPE}: 0.3-0.4\%
    \item \textbf{Temperature MAE}: 0.8-1.2°C
    \item \textbf{Inference Time}: ~200ms
    \item \textbf{Win Rate}: 5.6\% (1/18 segments)
\end{itemize}

\textbf{Key Features:}
\begin{itemize}
    \item ✓ Autoregressive step-by-step
    \item ✓ Median of 10 predictions
    \item ✓ Robust to noise
    \item ✓ Validation baseline
\end{itemize}
\end{bluebox}
...
\begin{itemize}
    \item \textbf{2-3× better accuracy}
    \item 0.158\% vs 0.3-0.4\% voltage MAPE
    \item 94.4\% win rate (17/18 segments)
...
\large
\textbf{5 Interactive Tabs:}
\begin{enumerate}
    \item ⚡ Predict Mode (MoE Transformer)
    \item 📊 Dataset Comparison \textbf{✨ NEW}
...
\begin{multicols}{3}
\begin{itemize}
    \item ✅ MoE architecture (0.158\% MAPE)
    \item ✅ 94.4\% win rate validation
    \item ✅ Real dataset comparison
    \item ✅ 5-tab web interface
    \item ✅ 8 pre-computed demos
...
Pandas (1.1GB CSV loading)

\columnbreak

\textbf{📧 Contact \& Code}\\
guda.reddy@iitgn.ac.in\\
